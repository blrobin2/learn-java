...
public class SearchTree implements NodeList {
    ...
    public boolean addItem(ListItem newItem) {
      if (this.root == null) {
          // the tree is empty, so our item becomes the head of tree
          this.root = newItem;
          return true;
      }
      ...
      while (currentItem != null) {
          ...
          if (comparison < 0) {
              ...
              if (currentItem.next() != null) {
                  ...
                  // there is no node to the right so add
      ...
      // If by some magic we get here, just return false
      return false;
    }
